...
/* EFEK TIMBUL: TOMBOL NEXT (PUSH BUTTON) */
.btn-next {
...
@media (max-width: 600px) {
    ...
    .question-group select { padding: 12px; font-size: 0.9rem; }
...
@media (max-width: 390px) {
    ...
    .question-group select { padding: 10px; font-size: 0.85rem; }
